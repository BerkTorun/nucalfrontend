  ...
  <div>
    ...
    >
      ...
      <div class="row mb-4">
        ...
        <div
          class="col-md-3"
          v-for="level in getLevelsReversed"
          :key="level.id"
        >
          <button
            class="btn btn-block"
            :class="[
              ...
              {
                'btn-disabled':
                  selectedLevel != null && selectedLevel != level.id,
              },
            ]"
      ...
      <div class="row">
        <label for="task" class="col-md-8 col-sm-12">Task Description</label>
        <small
          class="col-md-4 col-sm-12 text-right"
          v-if="description"
          :class="
            $v.description.$params.maxLength.max >= description.length
              ? 'text-success'
              : 'text-danger'
          "
          >{{ description.length }} /
      ...
      >
        <template v-if="$v.$invalid"
          >Please control the form before submit</template
        >
